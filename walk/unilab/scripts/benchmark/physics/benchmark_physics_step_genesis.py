...
Run without changing repo dependencies:
    uv run --with genesis-world \
        python scripts/benchmark/physics/benchmark_physics_step_genesis.py
"""
...
def _uv_run_hint() -> str:
    return "uv run --with genesis-world python scripts/benchmark/physics/benchmark_physics_step_genesis.py"
...
def main():
    ...
    parser.add_argument(
        "--out-dir",
        type=str,
        default="scripts/benchmark/outputs/physics_step/genesis",
