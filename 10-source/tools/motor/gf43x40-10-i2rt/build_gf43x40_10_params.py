#!/usr/bin/env python3
"""Build the deployable GF43X40-10 empty-load parameter file from fitted/raw data."""
...
def main() -> int:
    ...
    parser.add_argument("--output", default="data/processed/gf43x40_10_empty_fit.json")
    ...
    model = {
        "schema_version": 1,
        "model": "GF43X40-10 24 V CAN-observable output-shaft model",
        "data_scope": {
            "velocity_rounds": [1, 2],
        ...
        "datasheet_gf43x40_10_24V": {
            "source": "DuckResource/Motor/电机参数.pdf pages 7-10",
