#!/usr/bin/env python3
"""Timestamped I2RT CAN data collection for DM-J4340 bench identification.
...
from probe_dm_j4340 import Register, parse_ids
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Collect synchronized I2RT/DM-J4340 CAN identification data")
