"""Built-in API-v2 consumer for the right Kick model."""
import numpy as np
...
def build_command_obs(frame):
    if frame["policy_context"]["action"] != "kick_right":
        raise ValueError("right-kick consumer requires kick_right action")
