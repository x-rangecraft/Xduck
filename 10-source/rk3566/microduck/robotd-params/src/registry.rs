...
pub const REGISTRY: &[Entry] = &[
    // ── [bus] ────────────────────────────────────────────────────────────────
    entry("bus.port", Kind::Text, "STM32 motor gateway USB CDC device"),
    entry(
        "bus.imu_port",
        Kind::Text,
        "Reserved second-IMU port (ignored by DMUSB v4)",
    ),
    // ── [control] ────────────────────────────────────────────────────────────
    ...
    entry(
        ...
        Kind::Choice(crate::CAMERA_BACKEND_LABELS),
        "Camera capture path: rkisp for MIPI, uvc-mjpeg for a USB camera",
    ),
    entry(
        "media.camera_device",
        Kind::Text,
        "Stable V4L2 capture node used by mediad",
    ),
    feature(
        "media.quality",
    ...
    entry(
        "media.rotation",
        Kind::Integer,
        "Camera mounting angle clockwise: 0, 90, 180 or 270",
    ),
];
