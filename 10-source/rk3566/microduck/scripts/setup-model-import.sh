...
"$MODEL_PYTHON_DIR/bin/python" -I -c 'import torch, onnx, onnxruntime, numpy; print("model converter and two-file policy runtime:", torch.__version__, onnx.__version__, onnxruntime.__version__, numpy.__version__)'
