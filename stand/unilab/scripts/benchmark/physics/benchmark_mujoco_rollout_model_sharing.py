...
DEFAULT_OUTPUT_DIR = Path("scripts/benchmark/outputs/mujoco_rollout_model_sharing")
MODE_COLORS = {
...
def _load_device_info_helpers():
    device_info_path = Path(__file__).resolve().parent.parent / "core" / "device_info.py"
