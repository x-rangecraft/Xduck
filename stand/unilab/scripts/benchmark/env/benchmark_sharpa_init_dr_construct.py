...
Usage:
    uv run scripts/benchmark/env/benchmark_sharpa_init_dr_construct.py
    uv run scripts/benchmark/env/benchmark_sharpa_init_dr_construct.py --env-nums 256,512,1024
    uv run scripts/benchmark/env/benchmark_sharpa_init_dr_construct.py --variant-counts 1,2,4,8
    uv run scripts/benchmark/env/benchmark_sharpa_init_dr_construct.py --measure construct_plus_pool
"""
...
DEFAULT_OUTPUT_DIR = ROOT_DIR / "scripts" / "benchmark" / "outputs" / "sharpa_init_dr_construct"
